...
$(document).ready(function() {
    $.getJSON("https://sochain.com/api/v2/get_address_balance/BTCTEST/"+$(".bitcoin-address").val(),function(result){
    ...
    $.getJSON("https://sochain.com/api/v2/get_tx_unspent/BTCTEST/"+$(".bitcoin-address").val(),function(result) {
        if(result.status === "success"){
...
function postTransaction(itemid,postdata){
    $.post("https://sochain.com/api/v2/send_tx/BTCTEST/",postdata,function(result){
        if(result.status ==="success"){
