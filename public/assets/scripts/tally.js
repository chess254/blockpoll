...
/**
 * sochain.com API is shit changed to sochain.com
 **/
$.getJSON("https://sochain.com/api/v2/get_tx_received/BTCTEST/n4Kc1AwFos3aZRvD3Tc9imzeMeA8E9DEUr",function (result) {
...
function fetchCandidate(txid) {
    // console.log(txid);
    $.get("https://sochain.com/api/v2/tx/BTCTEST/"+txid,function(result){
